...
def runTicker(api, ticker):
    ...
    days_less_thr10=0
    days_less_thr15=0
    pd.set_option('display.max_rows', trade_days.shape[0]+1)    
    print(trade_days)

    #for myday in trade_days.index.unique():
    #    print(trade_days[trade_days.index==myday])
...
start_date = "2021-0%s-%sT14:00:00-04:00" %(month,day)
end_date = "2021-0%s-%sT20:50:00-04:00" %(month,day)
#start_date = "2021-0%s-%sT06:00:00-04:00" %(month,day)
#end_date = "2021-0%s-%sT08:50:00-04:00" %(month,day)
trades = GetTrades(ticker, start_date, end_date,limit=50000) #api.get_trades("TSLA", start_date, end_date, limit=50000).df
low_price = 52.

trades = trades.tz_convert(tz='US/Eastern')
print(trades)
